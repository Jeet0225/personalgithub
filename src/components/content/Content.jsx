    ...
    <div className='upper'>
      <div className='middle'>
        <div className='down' >
          <div className='search-input'>
            <input value={searchUser} ref={searchData} onClick={handleClick} name="search" className="form-control mr-sm-1 input" type="search" placeholder="Type here to Search Personal Github Profile" aria-label="Search" onChange={(e) => { handleChange(e) }} />
          </div>
      ...
      <div className='container my-5' >
        ...
        <button type="button" class="btn btn-info btn-sm"><BsFillStarFill/> Stars</button>
          ...
          <h2><BsGithub style={{marginRight:"20px"}} />  Welcome to Personal Github Site</h2>
           </div>}
